...
class PaywallPageWidget extends StatefulWidget {
  ...
  final AdaptyPaywallStruct? paywall;
...
class _PaywallPageWidgetState extends State<PaywallPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        Future(() async {
          await _model.getProductsActionBlock(context);
          safeSetState(() {});
          await _model.getProductsEligibilitiesActionBlock(context);
          safeSetState(() {});
        }),
        Future(() async {
          await actions.logShowPaywall(
            widget!.paywall!,
          );
        }),
      ]);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              'Know your subscription numbers',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                  ...
                  Builder(
                    builder: (context) {
                      final products = _model.currentProducts.toList();
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            productsItem.price.localizedString,
                                            'null',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .titleLarge
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            valueOrDefault<String>(
                                              _model.currentIntroEligibilities
                                                  .where((e) =>
                                                      e.vendorProductId ==
                                                      productsItem
                                                          .vendorProductId)
