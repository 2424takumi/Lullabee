...
class LoginMailWidget extends StatefulWidget {
  const LoginMailWidget({super.key});

  static String routeName = 'loginMail';
  static String routePath = '/loginMail';
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'login_mail_subtitle' /* メールアドレスとパスワードを
入力してください */
                      ,
                    ),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed(RegisterAutWidget.routeName);
                    },
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'create_account_link' /* アカウントをお持ちでない方はこちら */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.notoSansJp(
